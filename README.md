...
from each figure's viewBox aspect, so wider figures (Crafter, Cloner, Teacher,
Scientist, Locksmith, Coder, VibeCoder, Runner, JackSparrow, Investigator,
Cleaner, Mailer, Moper, Searcher, Signer, Snapper, Waiting) keep correct proportions instead of being squashed into a square.
...
| `Signer`       | `Size`, `Speed` (1–10), `Text`              |
| `Snapper`      | `Size`, `Speed` (1–10)                      |
